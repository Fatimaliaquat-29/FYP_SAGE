...
-----
  ...
  # Heuristic only (skip the LSTM), or headless (no window):
  python realtime_fall_detection.py --no-lstm --no-display
...
def run(input_source, use_lstm=True, show_display=True,
